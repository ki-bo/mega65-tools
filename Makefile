...
conanbuildinfo_win.mak: conanfile.txt conan/*
	conan install conanfile.txt --build=missing -pr:h=default -pr:h=conan/profile_win_host -pr:b=default -pr:b=conan/profile_win_build
